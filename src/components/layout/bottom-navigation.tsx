...
import { Home as HomeIcon, UserCircle, PackageSearch, CalendarDays } from 'lucide-react';
...
export function BottomNavigationBar() {
  ...
  ], [isClient, isStudentLoggedIn, t]); // t is included as labelKeys are dynamic

  if (!isClient) {
    // Return a simple placeholder for SSR or initial hydration to maintain layout space
