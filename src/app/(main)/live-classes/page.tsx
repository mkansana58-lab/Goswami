        ...
        {showAdminFeatures && (
          <CardContent className="border-t pt-6">
            ...
            <form onSubmit={onAdminSubmit} className="space-y-4">
              <div><label htmlFor="classTitle" className="block text-sm font-medium text-foreground">{t('liveClassTitleLabel')}</label><Input id="classTitle" value={classTitle} onChange={(e) => setClassTitle(e.target.value)} placeholder={t('liveClassTitlePlaceholder')} required className="mt-1 h-11" /></div>
              <div><label htmlFor="classSubject" className="block text-sm font-medium text-foreground">{t('liveClassSubjectLabel')}</label><Input id="classSubject" value={classSubject} onChange={(e) => setClassSubject(e.target.value)} placeholder={t('liveClassSubjectPlaceholder')} required className="mt-1 h-11" /></div>
              <div className="grid md:grid-cols-2 gap-4">
                <div><label htmlFor="classDate" className="block text-sm font-medium text-foreground">{t('liveClassDateLabel')}</label><Input id="classDate" type="text" value={classDate} onChange={(e) => setClassDate(e.target.value)} placeholder="YYYY-MM-DD" required className="mt-1 h-11" /></div>
                <div><label htmlFor="classTime" className="block text-sm font-medium text-foreground">{t('liveClassTimeLabel')}</label><Input id="classTime" type="text" value={classTime} onChange={(e) => setClassTime(e.target.value)} placeholder="HH:MM" required className="mt-1 h-11" /></div>
              </div>
              <div><label htmlFor="classLink" className="block text-sm font-medium text-foreground">{t('liveClassLinkLabel')}</label><Input id="classLink" type="url" value={classLink} onChange={(e) => setClassLink(e.target.value)} placeholder={t('liveClassLinkPlaceholder')} required className="mt-1 h-11" /></div>
