...
import { Newspaper } from 'lucide-react'; // Import Newspaper icon

// News data - copied from the original MainNews component for now
interface NewsItem {
  id: string;
  text: string;
}
    ...
    <div className="max-w-4xl mx-auto space-y-8">
      <Card className="shadow-xl">
        <CardHeader className="text-center pb-4">
          ...
          <CardTitle className="text-3xl font-bold font-headline text-primary">{t('latestNewsPageTitle')}</CardTitle>
          <CardDescription className="text-lg">{t('latestNewsPageDesc')}</CardDescription>
        </CardHeader>
