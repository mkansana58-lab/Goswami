...
const SuggestDifficultyLevelInputSchema = z.object({
  problemText: z.string().describe('The text of the practice problem to assess.'),
});
...
const SuggestDifficultyLevelOutputSchema = z.object({
  ...
  feedback: z.string().describe('Feedback on the problem and suggestions for similar problems.'),
});
