...
export const translations = {
  en: {
    ...
    studentRegisterDesc: "Create your student account.",
    passwordValidationMin: "Password must be at least 6 characters.",
    ...
    studentLoginDesc: "Access your student account.",
    ...
    currentClassPlaceholder: "Enter your current class/standard",
    profileNoDetails: "No additional profile details found. Click 'Edit Profile' to add them."
  },
  hi: {
    ...
    studentRegisterDesc: "अपना छात्र खाता बनाएं।",
    passwordValidationMin: "पासवर्ड कम से कम 6 अक्षरों का होना चाहिए।",
    ...
    studentLoginDesc: "अपने छात्र खाते तक पहुंचें।",
    dontHaveAccount: "खाता नहीं है?",
    loginSuccess: "लॉगिन सफल!",
    studentProfileTitle: "मेरी प्रोफाइल",
    ...
    fatherNamePlaceholder: "अपने पिता का नाम दर्ज करें",
    ...
    currentClassPlaceholder: "अपनी वर्तमान कक्षा/मानक दर्ज करें",
    profileNoDetails: "कोई अतिरिक्त प्रोफ़ाइल विवरण नहीं मिला। उन्हें जोड़ने के लिए 'प्रोफ़ाइल संपादित करें' पर क्लिक करें।"
  }
};
