...
export const translations = {
  en: {
    ...
    adminAccessNote: "To access this panel, please login as an administrator via the admin login page.",
  ...
  hi: {
    ...
    adminAccessNote: "इस पैनल तक पहुंचने के लिए, कृपया एडमिन लॉगिन पेज के माध्यम से एक व्यवस्थापक के रूप में लॉगिन करें।",
