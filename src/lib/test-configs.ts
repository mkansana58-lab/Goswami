...
export const testConfigs: Record<TestType, TestConfig> = {
  ...
  jnv: {
    'Class 6': [
      { key: 'Mental Ability', nameKey: 'subjectMentalAbility', questions: 40, totalMarks: 50 },
      { key: 'Arithmetic', nameKey: 'subjectArithmetic', questions: 20, totalMarks: 25 },
      { key: 'Language', nameKey: 'subjectLanguage', questions: 20, totalMarks: 25 },
    ],
    'Class 9': [
      { key: 'English', nameKey: 'subjectEnglish', questions: 15, totalMarks: 15 },
      { key: 'Hindi', nameKey: 'subjectHindi', questions: 15, totalMarks: 15 },
      { key: 'Mathematics', nameKey: 'subjectMathematics', questions: 35, totalMarks: 35 },
      { key: 'Science', nameKey: 'subjectGeneralScience', questions: 35, totalMarks: 35 },
    ],
  },
  subject_wise: {
      'All': [
          { key: 'Mathematics', nameKey: 'subjectMathematics', questions: 15, totalMarks: 30 },
          { key: 'General Knowledge', nameKey: 'subjectGeneralKnowledge', questions: 15, totalMarks: 30 },
          { key: 'Reasoning', nameKey: 'subjectReasoning', questions: 15, totalMarks: 30 },
          { key: 'Hindi', nameKey: 'subjectHindi', questions: 15, totalMarks: 30 },
          { key: 'English', nameKey: 'subjectEnglish', questions: 15, totalMarks: 30 },
          { key: 'General Science', nameKey: 'subjectGeneralScience', questions: 15, totalMarks: 30 },
      ]
  }
};
